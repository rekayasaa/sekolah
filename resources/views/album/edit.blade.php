    ...
    <div class="main-content" style="min-height: 490px;">
        <div class="card" id="settings-card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('album.update', $data['id']) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="form-group row align-items-right">
                        <label for="jdul" class="form-control-label col-sm-2 text-md-right">Judul</label>
