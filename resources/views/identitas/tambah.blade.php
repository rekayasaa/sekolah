                    ...
                    <div class="card" id="settings-card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('identitas.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row align-items-right">
                                    <label for="kor_lat" class="form-control-label col-sm-2 text-md-right">Kor_Lat</label>
                                    <div class="col-sm-6 col-md-9">
                                        <input type="text" name="kor_lat" value="{{ old('kor_lat') }}"
                                ...
                                <div class="form-group row align-items-right">
                                    <label for="kor_long" class="form-control-label col-sm-2 text-md-right">Kor_Long</label>
                                    <div class="col-sm-6 col-md-9">
                                        <input type="text" name="kor_long" value="{{ old('kor_long') }}"
