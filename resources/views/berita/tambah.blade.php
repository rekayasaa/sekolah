                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('berita.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row align-items-right">
                                ...
                                <div class="col-sm-6 col-md-9">
                                    <select class="form-control @error('penulis_id') is-invalid @enderror" name="penulis_id" id="penulis_id">
                                        ...
                                        <option value="{{ $user['id'] }}" {{ old('penulis_id') == $user['id'] ? 'selected' : '' }}>
                                            {{ $user['name'] }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row align-items-right">
                                ...
                                <div class="col-sm-6 col-md-9">
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="headline" value="Y" @checked(old('headline')) class="custom-switch-input" id="headline">
                            ...
                            <div class="form-group row align-items-right">
                                ...
                                <div class="col-sm-6 col-md-9">
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="publik" value="Y" @checked(old('publik')) class="custom-switch-input" id="publik">
                                        <span class="custom-switch-indicator"></span>
                                        <span class="custom-switch-description">Ya</span>
                                    </label>
                                </div>
