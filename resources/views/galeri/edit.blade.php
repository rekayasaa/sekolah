        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="/galeri">{{ $option['modul'] }}</a></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card" id="settings-card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('galeri.update', $data['id']) }}"
                                ...
                                <div class="form-group row align-items-right">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        <textarea class="summernote @error('keterangan') is-invalid @enderror" name="keterangan" style="display: none;"
                                            id="keterangan">
                            {{ $data['keterangan'] }}
                            </textarea>
                                        @error('keterangan')
                                ...
                                <div class="form-group row align-items-right">
                                    <label for="album_id" class="form-control-label col-sm-2 text-md-right">Album</label>
                                    <div class="col-sm-6 col-md-9">
                                        <select class="form-control @error('album_id') is-invalid @enderror" name="album_id"
                                            id="album_id">

                                            @foreach ($album as $al)
                                                <option value="{{ $al['id'] }}" @selected(old('album_id') == $al['id'])>
                                                    {{ $al['judul'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row align-items-right">
                                    ...
                                    <div class="col-sm-12 col-md-7 mt-3">
                                        ...
                                        <a href="/galeri" class="btn btn-danger waves-effect waves-light">Kembali</a>
                                    </div>
                                </div>
                            </form>
                        </div>
